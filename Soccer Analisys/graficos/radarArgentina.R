...
inputTeam <- function()
{
  team <- ask("Select an option? 1 - Argentina x Paraguai Jogo 1, 2 - Argentina x Uruguai Jogo 2, 
              3 - Argentina x Jamaica Jogo 3, 4 - Argentina x Colombia Jogo 4
              5 - Argentina x Paraguai Jogo 5, 6 - Argentina x Chile Jogo 6
              , 7 - All")
...
jogo1 = read.csv(paste(getwd(),"/inputcsv/","Argentina x Paraguai Jogo 1.csv", sep=""), sep = ";")
jogo2 = read.csv(paste(getwd(),"/inputcsv/","Argentina x Uruguai Jogo 2.csv", sep=""), sep = ";")
jogo3 = read.csv(paste(getwd(),"/inputcsv/","Argentina x Jamaica Jogo 3.csv", sep=""), sep = ";")
jogo4 = read.csv(paste(getwd(),"/inputcsv/","Argentina x Colombia Jogo 4.csv", sep=""), sep = ";")
jogo5 = read.csv(paste(getwd(),"/inputcsv/","Argentina x Paraguai Jogo 5.csv", sep=""), sep = ";")
jogo6 = read.csv(paste(getwd(),"/inputcsv/","Argentina x Chile Jogo 6.csv", sep=""), sep = ";")
...
for(i in 1:length(lista_sdo)) {
  ...
  if (team == 1 || team == 7){
    ...
    colors_border=c( "red" )
    colors_in=c( "darkred" )
    titulo = "Argentina x Paraguai Jogo 1"
  ...
  if (team == 2 || team == 7){
    ...
    titulo = "Argentina x Uruguai Jogo 2"
  }
  if (team == 3 || team == 7){
    ...
    colors_in=c( "orange")
    titulo = "Argentina x Jamaica Jogo 3"
  }
  ...
  if (team == 4 || team == 7){
    ...
    titulo = "Argentina x Colombia Jogo 4"
  }
  ...
  if (team == 5 || team == 7){
    ...
    colors_border=c( "blue" )
    colors_in=c("cyan" )
    titulo = "Argentina x Paraguai Jogo 5"
  }
  ...
  if (team == 6 || team == 7){
    ...
    colors_border=c( "red" )
    colors_in=c("pink" )
    titulo = "Argentina x Chile Jogo 6"
  }
